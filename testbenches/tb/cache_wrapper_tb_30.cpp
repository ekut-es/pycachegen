...
// replacement_policy=lru, hit_latency=0, miss_latency=0,
...
int sc_main(int argc, char** argv) {
    ...
    const std::unique_ptr<Vcache_wrapper_30> cache_wrapper{
        new Vcache_wrapper_30{"cache_wrapper"}};
    ...
    std::cout << "Vcache_wrapper_30 start!" << std::endl;
    ...
    if (vcd_file_path.empty()) {
        trace->open("Vcache_wrapper_tb_30.vcd");
    } else {
    ...
    std::cout << "Vcache_wrapper_30 done!" << std::endl;
    return exit_code;
}