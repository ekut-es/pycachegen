...
int sc_main(int argc, char** argv) {
    ...
    const std::unique_ptr<Vcache_wrapper_9> cache_wrapper{
        new Vcache_wrapper_9{"cache_wrapper"}};
    ...
    std::cout << "Vcache_wrapper_9 start!" << std::endl;
    ...
    if (vcd_file_path.empty()) {
        trace->open("Vcache_wrapper_tb_9.vcd");
    } else {
    ...
    try {
        ...
        write(6, 0x106, false);
        write(8, 0x108, false);
        write(10, 0x110, false);
        write(12, 0x112, false);
        write(14, 0x114, false);
    ...
    std::cout << "Vcache_wrapper_9 done!" << std::endl;
    return exit_code;
}