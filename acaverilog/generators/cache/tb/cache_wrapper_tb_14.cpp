...
// data_width=16, address_width=8, num_ways=4, num_sets=1,
...
int sc_main(int argc, char** argv) {
    ...
    const std::unique_ptr<Vcache_wrapper_14> cache_wrapper{
        new Vcache_wrapper_14{"cache_wrapper"}};
    ...
    if (vcd_file_path.empty()) {
        trace->open("Vcache_wrapper_tb_14.vcd");
    } else {
    ...
    std::cout << "Vcache_wrapper_14 done!" << std::endl;
    return 0;
}