...
// Main Memory: data_width=26 read_latency=10, write_latency=15
// min_address=0, max_address=16
...
int sc_main(int argc, char** argv) {
    ...
    const std::unique_ptr<Vcache_wrapper_27> cache_wrapper{
        new Vcache_wrapper_27{"cache_wrapper"}};
    ...
    std::cout << "Vcache_wrapper_27 start!" << std::endl;
    ...
    if (vcd_file_path.empty()) {
        trace->open("Vcache_wrapper_tb_27.vcd");
    } else {
    ...
    std::cout << "Vcache_wrapper_27 done!" << std::endl;
    return exit_code;
}