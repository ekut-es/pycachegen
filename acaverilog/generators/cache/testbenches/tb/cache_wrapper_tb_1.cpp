...
// L1: data_width=16, num_ways=1, num_sets=4,
...
int sc_main(int argc, char** argv) {
    ...
    const std::unique_ptr<Vcache_wrapper_1> cache_wrapper{
        new Vcache_wrapper_1{"cache_wrapper"}};
    ...
    std::cout << "Vcache_wrapper_1 start!" << std::endl;
    ...
    if (vcd_file_path.empty()) {
        trace->open("Vcache_wrapper_tb_1.vcd");
    } else {
    ...
    std::cout << "Vcache_wrapper_1 done!" << std::endl;
    return 0;
}