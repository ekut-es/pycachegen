...
int sc_main(int argc, char** argv) {
    ...
    const std::unique_ptr<Vcache_wrapper_24> cache_wrapper{
        new Vcache_wrapper_24{"cache_wrapper"}};
    ...
    std::cout << "Vcache_wrapper_24 start!" << std::endl;
    ...
    if (vcd_file_path.empty()) {
        trace->open("Vcache_wrapper_tb_24.vcd");
    } else {
    ...
    std::cout << "Vcache_wrapper_24 done!" << std::endl;
    return exit_code;
}
