    ...
    def generate_module(self) -> Module:
        ...
        Submodule(
            ...
            arg_ports=(
                ...
                # Cache In
                ("address_i", address_i),
                ("address_valid_i", address_valid_i),
                ("write_data_i", write_data_i),
                ("write_data_valid_i", write_data_valid_i),
                ("read_write_select_i", read_write_select_i),
                # Cache Out
                ("read_data_o", read_data_o),
                ("read_data_valid_o", read_data_valid_o),
                ("write_done_o", write_done_o),
                ("port_ready_o", port_ready_o),
                # Backend Cache <- Memory
                ("read_data_i", be_read_data),
                ("read_data_valid_i", be_read_data_valid),
                ("write_done_i", be_write_done),
                ("port_ready_i", be_port_ready),
                # Backend Cache -> Memory
                ("address_o", be_address),
                ("address_valid_o", be_address_valid),
                ("write_data_o", be_write_data),
                ("write_data_valid_o", be_write_data_valid),
                ("read_write_select_o", be_read_write_select),
            ),
        )
