...
set psu_pll_init_data {
    ...
    mask_write 0XFD1A0048 0x00003F00 0x00000300
		...
		# Lock circuit counter setting
		# PSU_CRF_APB_DPLL_CFG_LOCK_CNT                                                   0x28a

		# Lock circuit configuration settings for lock windowsize
		# PSU_CRF_APB_DPLL_CFG_LOCK_DLY                                                   0x3f

		# Helper data. Values are to be looked up in a table from Data Sheet
		#(OFFSET, MASK, VALUE)      (0XFD1A0030, 0xFE7FEDEFU ,0x7E514C62U)  */
    mask_write 0XFD1A0030 0xFE7FEDEF 0x7E514C62
		# : UPDATE FB_DIV
    ...
    # ce 110 aux_refclk[X] is the source 111 gt_crx_ref_clk is the source
		...
		# The integer portion of the feedback divider to the PLL
		# PSU_CRF_APB_DPLL_CTRL_FBDIV                                                     0x39
    ...
    # hange the VCO frequency, just the output frequency
		...
		# PLL Basic Control
		#(OFFSET, MASK, VALUE)      (0XFD1A002C, 0x00717F00U ,0x00013900U)  */
    mask_write 0XFD1A002C 0x00717F00 0x00013900
		# : BY PASS PLL
		# Register : DPLL_CTRL @ 0XFD1A002C</p>
...
set psu_ddr_init_data {
    ...
    mask_write 0XFD070000 0xE30FBE3D 0x81041010
    ...
    # ONLY.
		# PSU_DDRC_PWRTMG_T_DPD_X4096                                                     0x75
    ...
    # en. Unit: Multiples of 32 clocks FOR PERFORMANCE ONLY.
		...
		#(OFFSET, MASK, VALUE)      (0XFD070034, 0x00FFFF1FU ,0x00407510U)  */
    mask_write 0XFD070034 0x00FFFF1F 0x00407510
    ...
    # an 0x1. Unit: Multiples of 32 clocks.
		# PSU_DDRC_RFSHTMG_T_RFC_NOM_X32                                                  0x73
    ...
    # d. Unit: Clocks.
		# PSU_DDRC_RFSHTMG_T_RFC_MIN                                                      0xa7

		# Refresh Timing Register
		#(OFFSET, MASK, VALUE)      (0XFD070064, 0x0FFF83FFU ,0x007380A7U)  */
    mask_write 0XFD070064 0x0FFF83FF 0x007380A7
    ...
    # 2, and round it up to next integer value.
		# PSU_DDRC_INIT0_PRE_CKE_X1024                                                    0xe9

		# SDRAM Initialization Register 0
		#(OFFSET, MASK, VALUE)      (0XFD0700D0, 0xC3FF0FFFU ,0x000200E9U)  */
    mask_write 0XFD0700D0 0xC3FF0FFF 0x000200E9
    ...
    # gured to support LPDDR2. Unit: 32 clock cycles.
		# PSU_DDRC_INIT2_IDLE_AFTER_RESET_X32                                             0x1f
    ...
    # ypically requires 5 x tCK delay.
		...
		#(OFFSET, MASK, VALUE)      (0XFD0700D8, 0x0000FF0FU ,0x00001F05U)  */
    mask_write 0XFD0700D8 0x0000FF0F 0x00001F05
    ...
    # 1024 clocks.
		# PSU_DDRC_DRAMTMG0_T_RAS_MAX                                                     0x20
    ...
    # e next integer value. Unit: Clocks
		# PSU_DDRC_DRAMTMG0_T_RAS_MIN                                                     0x10

		# SDRAM Timing Register 0
		#(OFFSET, MASK, VALUE)      (0XFD070100, 0x7F3F7F3FU ,0x100F2010U)  */
    mask_write 0XFD070100 0x7F3F7F3F 0x100F2010
    ...
    # r value. Unit: Clocks.
		# PSU_DDRC_DRAMTMG1_T_RC                                                          0x17

		# SDRAM Timing Register 1
		#(OFFSET, MASK, VALUE)      (0XFD070104, 0x001F1F7FU ,0x00030417U)  */
    mask_write 0XFD070104 0x001F1F7F 0x00030417
    ...
    # round it up to the next integer value. Unit: Clocks.
		...
		#(OFFSET, MASK, VALUE)      (0XFD070114, 0x0F0F3F1FU ,0x05050303U)  */
    mask_write 0XFD070114 0x0F0F3F1F 0x05050303
    ...
    #  designs supporting mDDR or LPDDR2/LPDDR3/LPDDR4 devices.
		# PSU_DDRC_DRAMTMG7_T_CKPDX                                                       0x5

		# SDRAM Timing Register 7
		#(OFFSET, MASK, VALUE)      (0XFD07011C, 0x00000F0FU ,0x00000505U)  */
    mask_write 0XFD07011C 0x00000F0F 0x00000505
    ...
    # )+1. Present only in designs configured to support DDR4. Unit: clocks.
		# PSU_DDRC_DRAMTMG11_T_MPX_LH                                                     0x6
    ...
    # ion by 2, and round it up to next integer.
		...
		#(OFFSET, MASK, VALUE)      (0XFD07012C, 0x7F1F031FU ,0x1206010EU)  */
    mask_write 0XFD07012C 0x7F1F031F 0x1206010E
    ...
    # /LPDDR4 devices.
		# PSU_DDRC_ZQCTL1_T_ZQ_SHORT_INTERVAL_X1024                                       0x16a64

		# ZQ Control Register 1
		#(OFFSET, MASK, VALUE)      (0XFD070184, 0x3FFFFFFFU ,0x02016A64U)  */
    mask_write 0XFD070184 0x3FFFFFFF 0x02016A64
    ...
    # this field.
		...
		#(OFFSET, MASK, VALUE)      (0XFD070204, 0x001F1F1FU ,0x001F0808U)  */
    mask_write 0XFD070204 0x001F1F1F 0x001F0808
    ...
    mask_write 0XFD070208 0x0F0F0F0F 0x01010101
    ...
    mask_write 0XFD07020C 0x0F0F0F0F 0x0F010101
    ...
    # EBUG ONLY.
		...
		# PSU_DDRC_DBG0_DIS_WC                                                            0x1

		# Debug Register 0
		#(OFFSET, MASK, VALUE)      (0XFD070300, 0x00000011U ,0x00000001U)  */
    mask_write 0XFD070300 0x00000011 0x00000001
    ...
    # -AC is enabled
		# PSU_DDRC_PCCFG_BL_EXP_MODE                                                      0x1
    ...
    # t DDRC are driven to 1b'0.
		...
		#(OFFSET, MASK, VALUE)      (0XFD070400, 0x00000111U ,0x00000101U)  */
    mask_write 0XFD070400 0x00000111 0x00000101
    ...
    mask_write 0XFD080010 0xFFFFFFFF 0x07001E00
		...
		# Refresh Period
		# PSU_DDR_PHY_PGCR2_TREFPRD                                                       0xe3a0

		# PHY General Configuration Register 2
		#(OFFSET, MASK, VALUE)      (0XFD080018, 0xFFFFFFFFU ,0x00F0E3A0U)  */
    mask_write 0XFD080018 0xFFFFFFFF 0x00F0E3A0
    ...
    mask_write 0XFD080024 0xFFFFFFFF 0x010100F4
		...
		# PLL Power-Down Time
		# PSU_DDR_PHY_PTR0_TPLLPD                                                         0x1db

		# PLL Gear Shift Time
		# PSU_DDR_PHY_PTR0_TPLLGS                                                         0x76c

		# PHY Reset Time
		# PSU_DDR_PHY_PTR0_TPHYRST                                                        0x10

		# PHY Timing Register 0
		#(OFFSET, MASK, VALUE)      (0XFD080040, 0xFFFFFFFFU ,0x3B61DB10U)  */
    mask_write 0XFD080040 0xFFFFFFFF 0x3B61DB10
		# Register : PTR1 @ 0XFD080044</p>

		# PLL Lock Time
		# PSU_DDR_PHY_PTR1_TPLLLOCK                                                       0xb98c

		# Reserved. Returns zeroes on reads.
		# PSU_DDR_PHY_PTR1_RESERVED_15_13                                                 0x0

		# PLL Reset Time
		# PSU_DDR_PHY_PTR1_TPLLRST                                                        0x10b3

		# PHY Timing Register 1
		#(OFFSET, MASK, VALUE)      (0XFD080044, 0xFFFFFFFFU ,0xB98C10B3U)  */
    mask_write 0XFD080044 0xFFFFFFFF 0xB98C10B3
    ...
    mask_write 0XFD080100 0xFFFFFFFF 0x0800040C
		...
		#(OFFSET, MASK, VALUE)      (0XFD080110, 0xFFFFFFFFU ,0x07200F08U)  */
    mask_write 0XFD080110 0xFFFFFFFF 0x07200F08
    ...
    # QS/DQS# rising edge.
		...
		#(OFFSET, MASK, VALUE)      (0XFD080114, 0xFFFFFFFFU ,0x281D0008U)  */
    mask_write 0XFD080114 0xFFFFFFFF 0x281D0008
    ...
    mask_write 0XFD08011C 0xFFFFFFFF 0x83000800
		...
		# PSU_DDR_PHY_DTPR4_TXP                                                           0x6

		# DRAM Timing Parameters Register 4
		#(OFFSET, MASK, VALUE)      (0XFD080120, 0xFFFFFFFFU ,0x014D2B06U)  */
    mask_write 0XFD080120 0xFFFFFFFF 0x014D2B06
		...
		#(OFFSET, MASK, VALUE)      (0XFD080124, 0xFFFFFFFFU ,0x002D0F08U)  */
    mask_write 0XFD080124 0xFFFFFFFF 0x002D0F08
    ...
    mask_write 0XFD080564 0xFFFFFFFF 0x00000000
		...
		# PSU_DDR_PHY_ZQCR_PGWAIT_FRQA                                                    0x12
		...
		#(OFFSET, MASK, VALUE)      (0XFD080680, 0xFFFFFFFFU ,0x008A4A58U)  */
    mask_write 0XFD080680 0xFFFFFFFF 0x008A4A58
    ...
    mask_write 0XFD080B10 0xFFFFFFFF 0x0C00B000
    ...
    mask_write 0XFD080C10 0xFFFFFFFF 0x0C00B000
    ...
    mask_write 0XFD080D10 0xFFFFFFFF 0x0C00B000
    ...
    mask_write 0XFD080E10 0xFFFFFFFF 0x0C00B000
    ...
    mask_write 0XFD081480 0xFFFFFFFF 0x15019FFE
		...
		# DAXT8 0-1 PLL Control Register 0
		#(OFFSET, MASK, VALUE)      (0XFD081484, 0xFFFFFFFFU ,0x21100000U)  */
    mask_write 0XFD081484 0xFFFFFFFF 0x21100000
    ...
    mask_write 0XFD0814C0 0xFFFFFFFF 0x15019FFE
		...
		# DAXT8 0-1 PLL Control Register 0
		#(OFFSET, MASK, VALUE)      (0XFD0814C4, 0xFFFFFFFFU ,0x21100000U)  */
    mask_write 0XFD0814C4 0xFFFFFFFF 0x21100000
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180134 0x000000FE 0x000000C0
		...
		#(OFFSET, MASK, VALUE)      (0XFF180204, 0xFFFFFFFFU ,0x50000000U)  */
    mask_write 0XFF180204 0xFFFFFFFF 0x50000000
		...
		#(OFFSET, MASK, VALUE)      (0XFF180208, 0xFFFFFFFFU ,0x00B02006U)  */
    mask_write 0XFF180208 0xFFFFFFFF 0x00B02006
...
set psu_serdes_init_data {
    ...
    # eserved
		# PSU_SERDES_PLL_REF_SEL0_PLLREFSEL0                                              0xC

		# PLL0 Reference Selection Register
		#(OFFSET, MASK, VALUE)      (0XFD410000, 0x0000001FU ,0x0000000CU)  */
    mask_write 0XFD410000 0x0000001F 0x0000000C
    ...
    mask_write 0XFD410004 0x0000001F 0x0000000F
    ...
    #  - 108MHz, 0xF - 125MHz, 0x10 - 135MHz, 0x11 - 150 MHz. 0x12 to 0x1F - R
    # eserved
		# PSU_SERDES_PLL_REF_SEL2_PLLREFSEL2                                              0x9

		# PLL2 Reference Selection Register
		#(OFFSET, MASK, VALUE)      (0XFD410008, 0x0000001FU ,0x00000009U)  */
    mask_write 0XFD410008 0x0000001F 0x00000009
    ...
    mask_write 0XFD41000C 0x0000001F 0x00000009
    ...
    mask_write 0XFD402094 0x00000010 0x00000010
		...
		# PSU_SERDES_L2_PLL_SS_STEPS_0_LSB_SS_NUM_OF_STEPS_0_LSB                          0x58

		# Spread Spectrum No of Steps bits 7:0
		#(OFFSET, MASK, VALUE)      (0XFD40A368, 0x000000FFU ,0x00000058U)  */
    mask_write 0XFD40A368 0x000000FF 0x00000058
    ...
    mask_write 0XFD40E368 0x000000FF 0x00000058
    ...
    mask_write 0XFD40236C 0x00000007 0x00000003
		...
		# Spread Spectrum No of Steps [7:0]
		# PSU_SERDES_L1_PLL_SS_STEPS_0_LSB_SS_NUM_OF_STEPS_0_LSB                          0xE0

		# Spread Spectrum No of Steps bits 7:0
		#(OFFSET, MASK, VALUE)      (0XFD406368, 0x000000FFU ,0x000000E0U)  */
    mask_write 0XFD406368 0x000000FF 0x000000E0
    ...
    mask_write 0XFD40237C 0x00000033 0x00000030
		...
		# Step Size for Spread Spectrum [7:0]
		# PSU_SERDES_L1_PLL_SS_STEP_SIZE_0_LSB_SS_STEP_SIZE_0_LSB                         0xC9

		# Step Size for Spread Spectrum LSB
		#(OFFSET, MASK, VALUE)      (0XFD406370, 0x000000FFU ,0x000000C9U)  */
    mask_write 0XFD406370 0x000000FF 0x000000C9
		# Register : L1_PLL_SS_STEP_SIZE_1 @ 0XFD406374</p>

		# Step Size for Spread Spectrum [15:8]
		# PSU_SERDES_L1_PLL_SS_STEP_SIZE_1_SS_STEP_SIZE_1                                 0xD2

		# Step Size for Spread Spectrum 1
		#(OFFSET, MASK, VALUE)      (0XFD406374, 0x000000FFU ,0x000000D2U)  */
    mask_write 0XFD406374 0x000000FF 0x000000D2
    ...
    mask_write 0XFD406378 0x000000FF 0x00000001
		...
		# PSU_SERDES_L1_PLL_SS_STEP_SIZE_3_MSB_TM_FORCE_EN_SS                             0x1

		# Enable force on enable Spread Spectrum
		#(OFFSET, MASK, VALUE)      (0XFD40637C, 0x000000B3U ,0x000000B0U)  */
    mask_write 0XFD40637C 0x000000B3 0x000000B0
		# Register : L2_PLL_SS_STEP_SIZE_0_LSB @ 0XFD40A370</p>

		# Step Size for Spread Spectrum [7:0]
		# PSU_SERDES_L2_PLL_SS_STEP_SIZE_0_LSB_SS_STEP_SIZE_0_LSB                         0x7C

		# Step Size for Spread Spectrum LSB
		#(OFFSET, MASK, VALUE)      (0XFD40A370, 0x000000FFU ,0x0000007CU)  */
    mask_write 0XFD40A370 0x000000FF 0x0000007C
		# Register : L2_PLL_SS_STEP_SIZE_1 @ 0XFD40A374</p>

		# Step Size for Spread Spectrum [15:8]
		# PSU_SERDES_L2_PLL_SS_STEP_SIZE_1_SS_STEP_SIZE_1                                 0x33

		# Step Size for Spread Spectrum 1
		#(OFFSET, MASK, VALUE)      (0XFD40A374, 0x000000FFU ,0x00000033U)  */
    mask_write 0XFD40A374 0x000000FF 0x00000033
    ...
    mask_write 0XFD40E370 0x000000FF 0x0000007C
    ...
    mask_write 0XFD40E374 0x000000FF 0x00000033
    ...
    mask_write 0XFD4000F4 0x00000003 0x00000003
		# Register : L1_PLL_FBDIV_FRAC_3_MSB @ 0XFD406360</p>

		# Enable test mode force on fractional mode enable
		# PSU_SERDES_L1_PLL_FBDIV_FRAC_3_MSB_TM_FORCE_EN_FRAC                             0x1

		# Fractional feedback division control and fractional value for feedback d
    # ivision bits 26:24
		#(OFFSET, MASK, VALUE)      (0XFD406360, 0x00000040U ,0x00000040U)  */
    mask_write 0XFD406360 0x00000040 0x00000040
		# Register : L1_TM_DIG_6 @ 0XFD40506C</p>

		# Bypass 8b10b decoder
		# PSU_SERDES_L1_TM_DIG_6_BYPASS_DECODER                                           0x1

		# Enable Bypass for <3> TM_DIG_CTRL_6
		# PSU_SERDES_L1_TM_DIG_6_FORCE_BYPASS_DEC                                         0x1
		...
		# Data path test modes in decoder and descram
		#(OFFSET, MASK, VALUE)      (0XFD40506C, 0x0000000FU ,0x0000000FU)  */
    mask_write 0XFD40506C 0x0000000F 0x0000000F
		# Register : L1_TX_DIG_TM_61 @ 0XFD4040F4</p>

		# Enable/disable encoder bypass signal
		# PSU_SERDES_L1_TX_DIG_TM_61_BYPASS_ENC                                           0x1
		...
		# MPHY PLL Gear and bypass scrambler
		#(OFFSET, MASK, VALUE)      (0XFD4040F4, 0x0000000BU ,0x0000000BU)  */
    mask_write 0XFD4040F4 0x0000000B 0x0000000B
    ...
    # USB3 : SS
		# PSU_SERDES_L0_TM_IQ_ILL1_ILL_BYPASS_IQ_CALCODE_F0                               0x34

		# iqpi cal code
		#(OFFSET, MASK, VALUE)      (0XFD4018F8, 0x000000FFU ,0x00000034U)  */
    mask_write 0XFD4018F8 0x000000FF 0x00000034
		# Register : L0_TM_IQ_ILL2 @ 0XFD4018FC</p>

		# IQ ILL F1 CALCODE bypass value. MPHY : G1b, PCIE : Gen2, SATA: Gen2
		# PSU_SERDES_L0_TM_IQ_ILL2_ILL_BYPASS_IQ_CALCODE_F1                               0x34

		# iqpi cal code
		#(OFFSET, MASK, VALUE)      (0XFD4018FC, 0x000000FFU ,0x00000034U)  */
    mask_write 0XFD4018FC 0x000000FF 0x00000034
    ...
    mask_write 0XFD401928 0x000000FF 0x00000000
		...
		# PSU_SERDES_L0_TM_IQ_ILL3_ILL_BYPASS_IQ_CALCODE_F2                               0x34

		# iqpi cal code
		#(OFFSET, MASK, VALUE)      (0XFD401900, 0x000000FFU ,0x00000034U)  */
    mask_write 0XFD401900 0x000000FF 0x00000034
    ...
    mask_write 0XFD401994 0x00000007 0x00000007
		# Register : L1_TM_MISC2 @ 0XFD40589C</p>
    ...
    mask_write 0XFD40589C 0x00000080 0x00000080
		# Register : L1_TM_IQ_ILL1 @ 0XFD4058F8</p>

		# IQ ILL F0 CALCODE bypass value. MPHY : G1a, PCIE : Gen 1, SATA : Gen1 ,
    # USB3 : SS
		# PSU_SERDES_L1_TM_IQ_ILL1_ILL_BYPASS_IQ_CALCODE_F0                               0x7D

		# iqpi cal code
		#(OFFSET, MASK, VALUE)      (0XFD4058F8, 0x000000FFU ,0x0000007DU)  */
    mask_write 0XFD4058F8 0x000000FF 0x0000007D
		# Register : L1_TM_IQ_ILL2 @ 0XFD4058FC</p>

		# IQ ILL F1 CALCODE bypass value. MPHY : G1b, PCIE : Gen2, SATA: Gen2
		# PSU_SERDES_L1_TM_IQ_ILL2_ILL_BYPASS_IQ_CALCODE_F1                               0x7D

		# iqpi cal code
		#(OFFSET, MASK, VALUE)      (0XFD4058FC, 0x000000FFU ,0x0000007DU)  */
    mask_write 0XFD4058FC 0x000000FF 0x0000007D
		# Register : L1_TM_ILL12 @ 0XFD405990</p>

		# G1A pll ctr bypass value
		# PSU_SERDES_L1_TM_ILL12_G1A_PLL_CTR_BYP_VAL                                      0x1

		# ill pll counter values
		#(OFFSET, MASK, VALUE)      (0XFD405990, 0x000000FFU ,0x00000001U)  */
    mask_write 0XFD405990 0x000000FF 0x00000001
		# Register : L1_TM_E_ILL1 @ 0XFD405924</p>

		# E ILL F0 CALCODE bypass value. MPHY : G1a, PCIE : Gen 1, SATA : Gen1 , U
    # SB3 : SS
		# PSU_SERDES_L1_TM_E_ILL1_ILL_BYPASS_E_CALCODE_F0                                 0x9C

		# epi cal code
		#(OFFSET, MASK, VALUE)      (0XFD405924, 0x000000FFU ,0x0000009CU)  */
    mask_write 0XFD405924 0x000000FF 0x0000009C
		# Register : L1_TM_E_ILL2 @ 0XFD405928</p>

		# E ILL F1 CALCODE bypass value. MPHY : G1b, PCIE : Gen2, SATA: Gen2
		# PSU_SERDES_L1_TM_E_ILL2_ILL_BYPASS_E_CALCODE_F1                                 0x39

		# epi cal code
		#(OFFSET, MASK, VALUE)      (0XFD405928, 0x000000FFU ,0x00000039U)  */
    mask_write 0XFD405928 0x000000FF 0x00000039
		# Register : L1_TM_ILL11 @ 0XFD40598C</p>

		# G2A_PCIe1 PLL ctr bypass value
		# PSU_SERDES_L1_TM_ILL11_G2A_PCIEG1_PLL_CTR_11_8_BYP_VAL                          0x2

		# ill pll counter values
		#(OFFSET, MASK, VALUE)      (0XFD40598C, 0x000000F0U ,0x00000020U)  */
    mask_write 0XFD40598C 0x000000F0 0x00000020
		# Register : L1_TM_IQ_ILL3 @ 0XFD405900</p>

		# IQ ILL F2CALCODE bypass value. MPHY : G2a, SATA : Gen3
		# PSU_SERDES_L1_TM_IQ_ILL3_ILL_BYPASS_IQ_CALCODE_F2                               0x7D

		# iqpi cal code
		#(OFFSET, MASK, VALUE)      (0XFD405900, 0x000000FFU ,0x0000007DU)  */
    mask_write 0XFD405900 0x000000FF 0x0000007D
		# Register : L1_TM_E_ILL3 @ 0XFD40592C</p>

		# E ILL F2CALCODE bypass value. MPHY : G2a, SATA : Gen3
		# PSU_SERDES_L1_TM_E_ILL3_ILL_BYPASS_E_CALCODE_F2                                 0x64

		# epi cal code
		#(OFFSET, MASK, VALUE)      (0XFD40592C, 0x000000FFU ,0x00000064U)  */
    mask_write 0XFD40592C 0x000000FF 0x00000064
		# Register : L1_TM_ILL8 @ 0XFD405980</p>
    ...
    mask_write 0XFD405980 0x000000FF 0x000000FF
		# Register : L1_TM_IQ_ILL8 @ 0XFD405914</p>
    ...
    mask_write 0XFD405914 0x000000FF 0x000000F7
		# Register : L1_TM_IQ_ILL9 @ 0XFD405918</p>
    ...
    mask_write 0XFD405918 0x00000001 0x00000001
		# Register : L1_TM_E_ILL8 @ 0XFD405940</p>
    ...
    mask_write 0XFD405940 0x000000FF 0x000000F7
		# Register : L1_TM_E_ILL9 @ 0XFD405944</p>
    ...
    mask_write 0XFD405944 0x00000001 0x00000001
    ...
    # 2 - Sata1, 3 - USB0, 4 - DP.0, 5 - SGMII1, 6 - Unused, 7 - Unused
		# PSU_SERDES_ICM_CFG0_L1_ICM_CFG                                                  2

		# ICM Configuration Register 0
		#(OFFSET, MASK, VALUE)      (0XFD410010, 0x00000077U ,0x00000023U)  */
    mask_write 0XFD410010 0x00000077 0x00000023
    ...
    # 2 - Sata0, 3 - USB0, 4 - DP.1, 5 - SGMII2, 6 - Unused, 7 - Unused
		# PSU_SERDES_ICM_CFG1_L2_ICM_CFG                                                  4
    ...
    # 2 - Sata1, 3 - USB1, 4 - DP.0, 5 - SGMII3, 6 - Unused, 7 - Unused
		...
		#(OFFSET, MASK, VALUE)      (0XFD410014, 0x00000077U ,0x00000044U)  */
    mask_write 0XFD410014 0x00000077 0x00000044
		# : CHECKING PLL LOCK
		# : ENABLE SERIAL DATA MUX DEEMPH
		# Register : L2_TXPMD_TM_45 @ 0XFD408CB4</p>

		# Enable/disable DP post2 path
		# PSU_SERDES_L2_TXPMD_TM_45_DP_TM_TX_DP_ENABLE_POST2_PATH                         0x1

		# Override enable/disable of DP post2 path
		# PSU_SERDES_L2_TXPMD_TM_45_DP_TM_TX_OVRD_DP_ENABLE_POST2_PATH                    0x1

		# Override enable/disable of DP post1 path
		# PSU_SERDES_L2_TXPMD_TM_45_DP_TM_TX_OVRD_DP_ENABLE_POST1_PATH                    0x1

		# Enable/disable DP main path
		# PSU_SERDES_L2_TXPMD_TM_45_DP_TM_TX_DP_ENABLE_MAIN_PATH                          0x1

		# Override enable/disable of DP main path
		# PSU_SERDES_L2_TXPMD_TM_45_DP_TM_TX_OVRD_DP_ENABLE_MAIN_PATH                     0x1

		# Post or pre or main DP path selection
		#(OFFSET, MASK, VALUE)      (0XFD408CB4, 0x00000037U ,0x00000037U)  */
    mask_write 0XFD408CB4 0x00000037 0x00000037
		# Register : L3_TXPMD_TM_45 @ 0XFD40CCB4</p>
    ...
    mask_write 0XFD40CCB4 0x00000037 0x00000037
    ...
    mask_write 0XFD40C1D8 0x00000001 0x00000001
		...
		# Register : L1_TM_CDR5 @ 0XFD405C14</p>

		# FPHL FSM accumulate cycles
		# PSU_SERDES_L1_TM_CDR5_FPHL_FSM_ACC_CYCLES                                       0x7

		# FFL Phase0 int gain aka 2ol SD update rate
		# PSU_SERDES_L1_TM_CDR5_FFL_PH0_INT_GAIN                                          0x6

		# Fast phase lock controls -- FSM accumulator cycle control and phase 0 in
    # t gain control.
		#(OFFSET, MASK, VALUE)      (0XFD405C14, 0x000000FFU ,0x000000E6U)  */
    mask_write 0XFD405C14 0x000000FF 0x000000E6
		# Register : L1_TM_CDR16 @ 0XFD405C40</p>

		# FFL Phase0 prop gain aka 1ol SD update rate
		# PSU_SERDES_L1_TM_CDR16_FFL_PH0_PROP_GAIN                                        0xC

		# Fast phase lock controls -- phase 0 prop gain
		#(OFFSET, MASK, VALUE)      (0XFD405C40, 0x0000001FU ,0x0000000CU)  */
    mask_write 0XFD405C40 0x0000001F 0x0000000C
		# Register : L1_TM_EQ0 @ 0XFD40594C</p>

		# EQ stg 2 controls BYPASSED
		# PSU_SERDES_L1_TM_EQ0_EQ_STG2_CTRL_BYP                                           0x1

		# eq stg1 and stg2 controls
		#(OFFSET, MASK, VALUE)      (0XFD40594C, 0x00000020U ,0x00000020U)  */
    mask_write 0XFD40594C 0x00000020 0x00000020
		# Register : L1_TM_EQ1 @ 0XFD405950</p>

		# EQ STG2 RL PROG
		# PSU_SERDES_L1_TM_EQ1_EQ_STG2_RL_PROG                                            0x2

		# EQ stg 2 preamp mode val
		# PSU_SERDES_L1_TM_EQ1_EQ_STG2_PREAMP_MODE_VAL                                    0x1

		# eq stg1 and stg2 controls
		#(OFFSET, MASK, VALUE)      (0XFD405950, 0x00000007U ,0x00000006U)  */
    mask_write 0XFD405950 0x00000007 0x00000006
		# : GEM SERDES SETTINGS
    ...
    # phasis, Others: reserved
		# PSU_SERDES_L1_TX_ANA_TM_18_PIPE_TX_DEEMPH_7_0                                   0x1

		# Override for PIPE TX de-emphasis
		#(OFFSET, MASK, VALUE)      (0XFD404048, 0x000000FFU ,0x00000001U)  */
    mask_write 0XFD404048 0x000000FF 0x00000001
		# Register : L2_TXPMD_TM_48 @ 0XFD408CC0</p>

		# Margining factor value
		# PSU_SERDES_L2_TXPMD_TM_48_TM_RESULTANT_MARGINING_FACTOR                         0

		# Margining factor
		#(OFFSET, MASK, VALUE)      (0XFD408CC0, 0x0000001FU ,0x00000000U)  */
    mask_write 0XFD408CC0 0x0000001F 0x00000000
		# Register : L3_TXPMD_TM_48 @ 0XFD40CCC0</p>
    ...
    mask_write 0XFD40CCC0 0x0000001F 0x00000000
		# Register : L2_TX_ANA_TM_18 @ 0XFD408048</p>

		# pipe_TX_Deemph. 0: -6dB de-emphasis, 1: -3.5dB de-emphasis, 2 : No de-em
    # phasis, Others: reserved
		# PSU_SERDES_L2_TX_ANA_TM_18_PIPE_TX_DEEMPH_7_0                                   0

		# Override for PIPE TX de-emphasis
		#(OFFSET, MASK, VALUE)      (0XFD408048, 0x000000FFU ,0x00000000U)  */
    mask_write 0XFD408048 0x000000FF 0x00000000
    ...
    mask_write 0XFD40C048 0x000000FF 0x00000000
}
...
set psu_resetout_init_data {
    ...
    mask_write 0XFF5E0230 0x00000008 0x00000000
		...
		# PSU_SIOU_SATA_MISC_CTRL_SATA_PM_CLK_SEL                                         0x1

		# Misc Contorls for SATA.This register may only be modified during bootup
    # (while SATA block is disabled)
		#(OFFSET, MASK, VALUE)      (0XFD3D0100, 0x00000003U ,0x00000001U)  */
    mask_write 0XFD3D0100 0x00000003 0x00000001
		# Register : RST_FPD_TOP @ 0XFD1A0100</p>
...
mwr -force  0xFD080018 0x00F01B61
...
mwr -force  0xFD080018 0x00F102E9
