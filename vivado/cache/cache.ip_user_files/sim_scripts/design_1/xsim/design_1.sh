...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_15 -L zynq_ultra_ps_e_vip_v1_0_15 -L xilinx_vip"
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/media/richard/ext4hdd/Xilinx/Vivado/2023.2/data/xsim"
  fi
