...
proc create_ipi_design { offsetfile design_name } {
	...
	# Copy all address to cache_wrapper_1_v1_1_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/cache_wrapper_1_v1_1_include.tcl"
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/cache_wrapper_1_v1_1_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "cache_wrapper_1_v1_1_hw_${i}"
